    ...
    <div className="flex flex-col items-center justify-center pt-4 md:pt-10 xl:pt-20">
      ...
      <div className="space-x-2 pt-8 md:space-y-5 md:pt-12 xl:pt-16">
        <div className="max-w-md text-center">
          ...
          <Link href="/">
            <button className="focus-visible:shadow-outline-blue inline rounded-lg border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium leading-5 text-white shadow transition-colors duration-150 hover:bg-blue-700 focus-visible:outline-none dark:hover:bg-blue-500">
              Back to homepage
            </button>
          </Link>
        </div>
