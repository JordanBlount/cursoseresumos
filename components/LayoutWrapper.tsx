  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between">
        {/* NOTE: Subtracting a value from "svg" allows me to add some gutter/white space above the fold */}
        <div className="dark:opacity-15 absolute z-[-1] h-[calc(100svh-3rem)] w-full bg-dots bg-[length:1rem_1rem] opacity-10 sm:hidden"></div>
